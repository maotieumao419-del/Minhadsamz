...
# Đọc file Listing.json từ Phase Bổ sung thay vì Supabase
json_file = r"f:\Minhpython\Test3\phase_bo_sung\output\Listing.json"
...
try:
    ...
    # Làm sạch dữ liệu: Xóa các ký tự \n thừa trong cột SKU
    df = df.with_columns(pl.col("SKU").str.strip_chars())
